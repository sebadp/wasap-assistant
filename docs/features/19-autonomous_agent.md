...
📋 [Guía de testing](../testing/19-autonomous_agent_testing.md)

---

## Referencias

- Exec plan: [`docs/exec-plans/19-autonomous_agent_plan.md`](../exec-plans/19-autonomous_agent_plan.md)
- Sprint 2 plan: [`20-autonomous_agent_sprint2_plan.md`](../exec-plans/20-autonomous_agent_sprint2_plan.md)
- Sprint 3 plan: [`21-autonomous_agent_sprint3_plan.md`](../exec-plans/21-autonomous_agent_sprint3_plan.md)
- Agent Mode base: [`docs/features/18-agentic_sessions.md`](18-agentic_sessions.md)
- Evaluación Claude Code: [`docs/exec-plans/EX-claude_code_experience.md`](../exec-plans/EX-claude_code_experience.md)
- Evaluación OpenClaw: [`docs/exec-plans/EX-openclaw_experience.md`](../exec-plans/EX-openclaw_experience.md)
